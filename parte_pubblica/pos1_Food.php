                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">ABOUNT ME <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="pos2_Food.php">Page 1</a></li>
                            <li><a href="pos3_Food.php">Page 2</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 post-title-block">
                ...
                <h1 class="text-center">Reflusso Gastroesofageo 🥗</h1>
                <ul class="list-inline text-center">
                  
                </ul>
            </div>
            <div class="col-lg-9 col-md-9 col-sm-12">
                <p class="lead">a dieta per il reflusso gastroesofageo è finalizzata ad evitare e ridurre i sintomi di questa problematica. Oltre alla scelta degli alimenti risultano importanti anche altri aspetti legati alle nostre abitudini alimentari come, ad esempio, il tempo dedicato alla masticazione ed il volume dei pasti.
